        ...
        for y in range(0,Maze.Y):
            for z in range(0,Maze.Z):
                if Maze.Xwall[x][y][z] == True:
                    ...
                    edgeIndices = edgeIndices + [offset + 2, offset + 3]
                    edgeIndices = edgeIndices + [offset + 3, offset + 0]

                    surfIndices = surfIndices + [offset + 0, offset + 1, offset + 2]
                    surfIndices = surfIndices + [offset + 2, offset + 3, offset + 0]
